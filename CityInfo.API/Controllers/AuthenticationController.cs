...
namespace CityInfo.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        // this also won't be used outside of this class
        ...
        public ActionResult<string> Authenticate([FromBody] AuthenticationRequestBody authenticationRequestBody)
        {
            ...
            // The claims that will go into jwt security token
        ...
        {
            // we don't have a user db/table. if you have, check the passed through username/hashed password against db.
            // for demo purposes, we assume credentials are valid.

            // return a new CityInfoUser (values would normally come from user db here)
